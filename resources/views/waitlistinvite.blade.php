...
$mail->IsSMTP();
            ...
            $mail->Subject = "Leap into an exciting group experience!"; //subject
            $body = "";
            //message
         
            $body .= "You have been invited to join the Leap group experience<br />";
        
        $body .= "Download the Leap app or go to <a href='http://anyleap.com'>anyleap.com</a>. Either create a group or leap into other exclusive groups with a leap code.</strong><br /><br />";
        ...
        $body .= "<a href='http://anyleap.com'> <img src='https://upload.wikimedia.org/wikipedia/commons/5/5d/Available_on_the_App_Store_(black).png' height='50px' /></a>";
            ...
            */
            ...
            $calltoaction = "+1" . $calltoaction;
                ...
                $body = "Someone has invited you into the Leap group experience. Get the Leap app (iOS/Android) (or go to anyleap.com)";
